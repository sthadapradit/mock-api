...
pub struct Landmarks {
    ...
    #[serde(default)]
    pub top_landmark: Option<Vec<TopLandmark>>,
    pub beach: Vec<Value>,
}
...
pub struct RateCategories {
    #[serde(default)]
    pub escape_rate_categories: Option<Vec<EscapeRateCategory>>,
}
...
pub struct Pricing {
    ...
    #[serde(default)]
    pub cheapest_stay_package_rate_plans: Option<Vec<CheapestStayPackageRatePlan>>,
